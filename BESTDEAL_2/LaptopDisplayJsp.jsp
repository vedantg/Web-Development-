...
<%
List<Product> product_list_lap = new ArrayList<Product>();
...
String key;
int flag;
String key_nm = "Laptop";
product_list_lap = MySqlDataStoreUtilities.selectLaptop(key_nm);
//product_list_lap = SaxParser4ProductXMLdataStore.m.get("Laptop");
...
%>
        ...
        <li><a href="#">Laptops</a></li>  <li><a href="TvDisplayJsp.jsp">TV</a></li>  </ul>  </li>  <li><a href="FindReviewsJsp.jsp">Trending</a></li> </ul>
        ...
        %>   
         ...
         %>
            ...
            <li><a href="#">Home Page</a></li><li><a>Our Products</a><ul><li><a href="SmartPhoneDisplayJsp.jsp">Smart Phones</a></li><li><a href="TabletDisplayJsp.jsp">Tablets</a></li><li><a href="#">Laptops</a></li><li><a href="TvDisplayJsp.jsp">TV</a></li></ul></li><li><a href="FindReviewsJsp.jsp">Trending</a></li></ul></li>

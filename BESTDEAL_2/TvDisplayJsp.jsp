...
<%
List<Product> product_list_tv = new ArrayList<Product>();
...
%>
        ...
        <a href="#">Products</a>  <ul class="sub-menu">  <li><a href="SmartPhoneDisplayJsp.jsp">Smart Phones</a></li>  <li><a href="TabletDisplayJsp.jsp">Tablets</a></li>  <li><a href="#"></a></li>
        <li><a href="LaptopDisplayJsp.jsp">Laptops</a></li>  <li><a href="#">TV</a></li>  </ul>  </li>  <li><a href="FindReviewsJsp.jsp">Trending</a></li> </ul>
        ...
        %>   
         ...
         %>
            ...
            <li><a href="#">Home Page</a></li><li><a>Our Products</a><ul><li><a href="SmartPhoneDisplayJsp.jsp">Smart Phones</a></li><li><a href="TabletDisplayJsp.jsp">Tablets</a></li><li><a href="LaptopDisplayJsp.jsp">Laptops</a></li><li><a href="#">TV</a></li></ul></li><li><a href="FindReviewsJsp.jsp">Trending</a></li></ul></li>

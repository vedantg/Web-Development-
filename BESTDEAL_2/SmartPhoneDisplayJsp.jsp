...
<%
List<Product> product_list_sm = new ArrayList<Product>();
...
String key;
int flag;
String key_nm = "SmartPhone";
product_list_sm = MySqlDataStoreUtilities.selectSmartPhone(key_nm);
//product_list_sm = SaxParser4ProductXMLdataStore.m.get("SmartPhone");
...
%>		
        ...
        %>   
         ...
         %>
            ...
            <li><a href="#">Home Page</a></li><li><a>Our Products</a><ul><li><a href="#">Smart Phones</a></li><li><a href="TabletDisplayJsp.jsp">Tablets</a></li><li><a href="LaptopDisplayJsp.jsp">Laptops</a></li><li><a href="TvDisplayJsp.jsp">TV</a></li></ul></li><li><a href="FindReviewsJsp.jsp">Trending</a></li></ul></li>

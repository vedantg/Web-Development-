...
%>
        ...
        <body>
        <div id="container">
        <header>  <div class="header_logo">  <img src="images/images_logo_new.jpg"/>  <h1><a href="/Assignment2_Test/IndexPageServlet">BEST <span>DEAL</span></a></h1>
        <h2>Your One Stop Shop</h2>
<%
      mapInFile = MySqlDataStoreUtilities.selectUpdatedOrderHistory(productformid); 
...
%>
        ...
        <tr><td>price</td><td><input type="text" readonly="true" size="15" value="<%=o.price %>" name="price1"/></td></tr>

...
public class SmartPhoneDisplayServlet extends HttpServlet {

public List<Product> product_list_sm = new ArrayList<Product>();
public String key_nm = "SmartPhone";
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, java.io.IOException {
        ...
        product_list_sm = MySqlDataStoreUtilities.selectSmartPhone(key_nm);

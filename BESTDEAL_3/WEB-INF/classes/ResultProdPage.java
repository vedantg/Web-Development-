...
public class ResultProdPage extends HttpServlet {

	public List<Product> product_list = new ArrayList<Product>();
 ...
 protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, java.io.IOException 
	{
		...
		String targetId = request.getParameter("prodid");

		product_list = MySqlDataStoreUtilities.selectResultProduct(targetId);
        ...
        out.println("<li><a href='#'>Laptops</a></li>" + "<li><a href='/Assignment4/TvDisplayServlet'>TV</a></li>" + "</ul>" + "</li>" + "<li><a href='/Assignment4/FindReviewsServlet'>Trending</a></li>"+"</ul>");

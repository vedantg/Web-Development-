...
public class TabletDisplayServlet extends HttpServlet {

public List<Product> product_list_tab = new ArrayList<Product>();
public String key_nm = "Tablet";
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println("<a href='#'>Products</a>" + "<ul class='sub-menu'>" + "<li><a href='/Assignment4/SmartPhoneDisplayServlet'>Smart Phones</a></li>" + "<li><a href='#'>Tablets</a></li>"+ " <li><a href='#'></a></li>");
        ...
        for (Product p : product_list_tab) {
            ...
            out.println("<li><a href='#'>Home Page</a></li><li><a>Our Products</a><ul><li><a href='/Assignment4/SmartPhoneDisplayServlet'>Smart Phones</a></li><li><a href='#'>Tablets</a></li><li><a href='/Assignment4/LaptopDisplayServlet'>Laptops</a></li><li><a href='/Assignment4/TvDisplayServlet'>TV</a></li></ul></li>"+"<li><a href='/Assignment4/FindReviewsServlet'>Trending</a></li></ul></li>");

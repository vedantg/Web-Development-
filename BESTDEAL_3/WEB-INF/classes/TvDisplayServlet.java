...
public class TvDisplayServlet extends HttpServlet  {

public List<Product> product_list_tv = new ArrayList<Product>();
public String key_nm = "TV";
    ...
    throws ServletException, java.io.IOException {
        ...
        product_list_tv = MySqlDataStoreUtilities.selectTV(key_nm);          
        ...
        out.println("<h2>Your One Stop Shop</h2>" + "<span style='width:110px;display:inline-block'></span>" + "<h2 style='float:right'>Welcome "+ username_cap +" !"+"<span style='width:110px;display:inline-block'><a href='#'></a></span>" +"<a href='/Assignment4/SignOutServlet'>Sign <span>Out</span></a></h2>" + "</div>" + "</header>");
        out.println("<div class='menu-wrap'>" + "<nav class='menu'>" + "<ul class='clearfix'>" + " <li><a href='/Assignment4/IndexPageServlet'>Home</a></li>" + "<li>");
        out.println("<a href='#'>Products</a>" + "<ul class='sub-menu'>" + "<li><a href='/Assignment4/SmartPhoneDisplayServlet'>Smart Phones</a></li>" + "<li><a href='/Assignment4/TabletDisplayServlet'>Tablets</a></li>"+ " <li><a href='#'></a></li>");
        out.println("<li><a href='/Assignment4/LaptopDisplayServlet'>Laptops</a></li>" + "<li><a href='#'>TV</a></li>" + "</ul>" + "</li>" + "<li><a href='/Assignment4/FindReviewsServlet'>Trending</a></li>"+ "</ul>");
        ...
        for (Product p : product_list_tv) {
            ...
            out.println("<form action='/Assignment4/AddToCartServlet' method='get' style='margin-bottom:20px;'>"+
                        ...
                        "</form>");            
            out.println("<form action='/Assignment4/WriteReviewsServlet' method='get' style='margin-bottom:20px;'>"+
                        ...
                        "</form>");
            out.println("<form action='/Assignment4/ReadReviewsServlet' method='get' style='margin-bottom:20px;'>"+
                        "<input type='hidden' name='productFormId' value='"+p.id+"' />" +

...
public class AddAdminProductDesignServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException 
    {
        ...
        out.println("<header>" + "<div class='header_logo'>" + "<img src='images/images_logo_new.jpg'/>" + "<h1><a href='/Assignment4/AdminPageServlet'>BEST <span>DEAL</span></a></h1>");
        ...
        out.println("<form method='post' action='/Assignment4/AddAdminProductServlet'><h3>Add Products</h3><table cellpadding='2' cellspacing='1'>");

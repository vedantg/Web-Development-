        ...
        if(userid != null && password != null) {
                ...
                if(realpassword != null &&
                    realpassword.equals(password) && userid.equals("admin")) {
                        ...
                        response.sendRedirect("/Assignment4/AdminPageServlet"); 

                } else if(userid.equals("sales")) {

                        HttpSession session=request.getSession(); 
                        session.setAttribute("userid",userid);  
                        response.sendRedirect("/Assignment4/SalesPageServlet");  
                                ...
                                if(flag==1)
                                 {
                                    HttpSession session=request.getSession(); 
                                    session.setAttribute("userid",userid);  
                                    response.sendRedirect("/Assignment4/IndexPageServlet");
                                 }

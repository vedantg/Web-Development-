	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(cursor1.count() == 0){
			out.println("There are no reviews for this product.");
				...
				out.println
          ("</TABLE>\n" +
           "<FORM ACTION=/Assignment4/IndexPageServlet  " +
		   " METHOD=\"get\">\n"+
           "<BIG><LEFT>\n" +
		   "<INPUT TYPE=\"SUBMIT\"\n" +
           "       VALUE=\"Back\">\n" +

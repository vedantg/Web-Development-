...
public class vice : System.Web.Services.WebService
{
    ...
    void sendMail(string mail)
    {
            ...
            MailMessage msg = new MailMessage("vedu16@gmail.com", mail, "NEW APPLICANT", s3);
            SmtpClient mailClient = new SmtpClient("smtp.gmail.com", 587);
            //Change your gmail user id and password for send email
            NetworkCredential NetCrd = new NetworkCredential("vedu16@gmail.com", "ved30513");
        ...
        /* try
         {
             ...
             string sqlQuery = "select * from STUDENT where STUD_ID='BES5001'";
             ...
             {
                 /*
                 b.blogID = reader["INST_NAME"].ToString();
                 b.blogTitle = reader["INST_NAME"].ToString();
                 b.blogPostID = reader["INST_NAME"].ToString();
                 b.blogPostContent = reader["INST_NAME"].ToString();
                 b.blogPostTime = reader["INST_NAME"].ToString();
                 b.commentID = reader["INST_NAME"].ToString();
                 b.commentContent = reader["INST_NAME"].ToString();
                 b.commentTime = reader["INST_NAME"].ToString();
        ...
        try
        {
            ...
            while (reader.Read())
            {
                ...
                for (int x = 0; x < stud_cor.Count; x++)
                {
                    ...
                    int v1 = String.Compare("YES", reader["STATUS"].ToString());

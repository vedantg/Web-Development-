...
public class SubmitReviewServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(category.equals("Laptop")){
        	out.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/Assignment5/LaptopDisplayServlet'>Click here to redirect</a>");
        }

        else if(category.equals("TV")){
        	out.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/Assignment5/TvDisplayServlet'>Click here to redirect</a>");
        }

        else if(category.equals("Tablet")){
        	out.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/Assignment5/TabletDisplayServlet'>Click here to redirect</a>");
        }

        else if(category.equals("SmartPhone")){
        	out.println("<span style='width:310px;display:inline-block'></span>"+"<a href='/Assignment5/SmartPhoneDisplayServlet'>Click here to redirect</a>");
        }				

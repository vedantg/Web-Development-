...
public class HomeServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println("<center><input type='submit' value='Login' style='margin-right:100px;'/></center>" + "</td>" + "</tr>" + "</table>" + "</form>" + "<h5>Don't have an account click- <a href='/Assignment5/SignupDesignServlet'>Sign Up</a></h5>");
        out.println("</div>" );

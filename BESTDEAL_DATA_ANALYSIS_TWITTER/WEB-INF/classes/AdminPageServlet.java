...
out.println("<h2>Your One Stop Shop</h2>" + "<span style='width:110px;display:inline-block'></span>" + "<h2 style='float:center','font-size:900%'>Welcome"+ "<span style='width:70px;display:inline-block;float:right'></span>"+" !  <a href='/Assignment5/SignOutServlet'>Sign <span>Out</span></a></h2>" + "</div>" + "</header>");
...
out.println("<th>Price</th>"+"</tr>");
         ...
         out.println("<td>"+"<a href='/Assignment5/AddAdminProductDesignServlet'><b>Add Product </b></a>"+"</td>");
         out.println("</tr>");
         out.println("<a href='/Assignment5/DataAnalyticsDesignServlet'>Data<span>Analytics</span></a>");
         out.println("<form method='post' action='/Assignment5/UpdateAdminDesignProductServlet'>"+"<p>Enter the Product ID which you want to update</p>");
         out.println("<input type='text' name='productUpdateId'>"+"<input type='submit' name='submit'>"+"</form>");
         out.println("<form method='post' action='/Assignment5/DeleteAdminProductServlet'>"+"<p>Enter the Product ID which you want to delete</p>");

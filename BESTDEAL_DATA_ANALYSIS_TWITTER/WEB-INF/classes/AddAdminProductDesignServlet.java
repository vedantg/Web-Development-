...
public class AddAdminProductDesignServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException 
    {
        ...
        out.println("<form method='post' action='/Assignment5/AddAdminProductServlet'><h3>Add Products</h3><table cellpadding='2' cellspacing='1'>");
        ...
        out.println("<tr><td>Product Id</td><td><input type='TEXT' size='15' name='productId' placeholder='L/V/T/S###'></input></td></tr>");
        ...
        out.println("<tr><td>Set Image</td><td><input type='TEXT' size='20' name='productImg' placeholder='images/Ur_image.jpg'></input></td></tr>");

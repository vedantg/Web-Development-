...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, java.io.IOException 
    {
        ...
        out.println("<h2>Your One Stop Shop</h2>" + "<span style='width:110px;display:inline-block'></span>" + "<h2 style='float:center','font-size:900%'>Welcome "+ " !<a href='/Assignment5/SignOutServlet'>Sign <span>Out</span></a></h2>" + "</div>" + "</header>");                                                    
        out.println("<form method='post' action='/Assignment5/UpdateAdminProductServlet'><h3>Edit Products</h3><table cellpadding='2' cellspacing='1'>");

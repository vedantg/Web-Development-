...
public class HomeServlet extends HttpServlet {
    ...
    throws ServletException, java.io.IOException {
        ...
        out.println("<div id='body'>" + "<section id='content'>" + "<article>" + "<form method='post' action='/Assignment2_Test/LoginServlet'>");
        ...
        out.println("<center><input type='submit' value='Login' style='margin-right:100px;'/></center>" + "</td>" + "</tr>" + "</table>" + "</form>" + "<h5>Don't have an account click- <a href='/Assignment2_Test/SignupDesignServlet'>Sign Up</a></h5>");
        out.println("</div>" );

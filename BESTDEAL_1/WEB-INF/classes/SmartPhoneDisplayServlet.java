...
public class SmartPhoneDisplayServlet extends HttpServlet implements Serializable {

transient List<Product> product_list_sm = new ArrayList<Product>();
       ...
       // try{
                                ...
                                {                   
                                    ...
                                    if(key.equals("SmartPhone"))
                                    {
                                        ...
                                        System.out.println("Laptop_List::"+sm_list);
                                        break;
                                    }                                                 
                                }

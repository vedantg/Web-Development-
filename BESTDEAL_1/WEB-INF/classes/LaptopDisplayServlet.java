...
public class LaptopDisplayServlet extends HttpServlet implements Serializable {

transient List<Product> product_list_laptop = new ArrayList<Product>();
...
public ServletContext sc;
    ...
    throws ServletException, java.io.IOException {
        ...
        //SaxParser4ProductXMLdataStore.loadProducts();
                       // try{
                                ...
                                product_list_laptop = SaxParser4ProductXMLdataStore.m.get("Laptop");
                                ...
                                {                   
                                    ...
                                    if(key.equals("Laptop"))
                                    {
                                        ...
                                        System.out.println("Laptop_List::"+laptop_list);
                                        break;
                                    }                                                 
                                }
        ...
        out.println("<h2>Your One Stop Shop</h2>" + "<span style='width:110px;display:inline-block'></span>" + "<h2 style='float:right'>Welcome "+ username_cap +" !"+"<span style='width:110px;display:inline-block'><a href='#'>CART:"+ total_price +"</a></span>" +"<a href='/Assignment2_Test/SignOutServlet'>Sign <span>Out</span></a></h2>" + "</div>" + "</header>");
        ...
        out.println("<a href='#'>Products</a>" + "<ul class='sub-menu'>" + "<li><a href='/Assignment2_Test/SmartPhoneDisplayServlet'>Smart Phones</a></li>" + "<li><a href='/Assignment2_Test/TabletDisplayServlet'>Tablets</a></li>" + " <li><a href='#'></a></li>");
        out.println("<li><a href='#'>Laptops</a></li>" + "<li><a href='/Assignment2_Test/TvDisplayServlet'>TV</a></li>" + "</ul>" + "</li>" + "<li><a href='/Assignment2_Test/FindReviewsServlet'>Trending</a></li>"+"</ul>");
		...
		for (Product p : product_list_laptop) {
    ...
    /*public void WriteToCartFile(){

         try{
        //System.out.println("here");
        File cartDataStore=new File("C:\\apache-tomcat-7.0.34\\webapps\\Assignment2_Test\\AddToCartFile");
        //cartDataStore.createNewFile();
        //System.out.println("here1");
        FileOutputStream tvfos=new FileOutputStream(cartDataStore);

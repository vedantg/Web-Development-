...
public class TvDisplayServlet extends HttpServlet implements Serializable {

transient List<Product> product_list_tv = new ArrayList<Product>();
...
public ServletContext sc;
    ...
    throws ServletException, java.io.IOException {
        ...
        /*try{
                            ...
                            product_list_tv = SaxParser4ProductXMLdataStore.m.get("TV");
        ...
        out.println("<li><a href='/Assignment2_Test/LaptopDisplayServlet'>Laptops</a></li>" + "<li><a href='#'>TV</a></li>" + "</ul>" + "</li>" + "<li><a href='/Assignment2_Test/FindReviewsServlet'>Trending</a></li>"+ "</ul>");
